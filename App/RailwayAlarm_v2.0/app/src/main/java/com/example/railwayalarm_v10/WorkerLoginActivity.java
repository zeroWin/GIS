...
//            lastMode = mode;
            mode = msg.what;
            if (mode==11){
                Toast.makeText(WorkerLoginActivity.this,inputNum+"登录成功",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(WorkerLoginActivity.this,WorkerActivity.class);
//                intent.putExtra("inputNum",inputNum);
                startActivity(intent);
                Intent intent1 = new Intent(WorkerLoginActivity.this,WorkerService.class);
                ...
                Intent intent_this = new Intent(WorkerLoginActivity.this,WorkerLoginActivity.class);
                startActivity(intent_this);
                Toast.makeText(WorkerLoginActivity.this,"用户名不存在！！！",Toast.LENGTH_LONG).show();
            }
        }
    };
